...
exports.MACRO_TO_ROLE = exports.MACRO_ADJUSTMENT_ORDER = void 0;
exports.calculateIngredientRole = calculateIngredientRole;
exports.calculateMaxPerMealGrams = calculateMaxPerMealGrams;
exports.getPreferredRangeGrams = getPreferredRangeGrams;
exports.enhanceIngredientWithRole = enhanceIngredientWithRole;
exports.enhanceIngredientsWithRoles = enhanceIngredientsWithRoles;
exports.createEmptyConstraints = createEmptyConstraints;
exports.recordConstraintHit = recordConstraintHit;
 ...
 */
function calculateIngredientRole(macros) {
...
const PORTION_LIMITS_BY_ROLE = {
    protein: {
        ...
        macroPerKgLimit: constants_1.PORTION_CONSTRAINTS.MAX_PROTEIN_PER_MEAL_G_PER_KG,
        limitMacro: 'protein',
    },
    carb: {
 ...
 */
function calculateMaxPerMealGrams(ingredient, role, bodyweightKg) {
 ...
 */
function getPreferredRangeGrams(role) {
 ...
 */
function enhanceIngredientWithRole(ingredient, bodyweightKg) {
 ...
 */
function enhanceIngredientsWithRoles(ingredients, bodyweightKg) {
 ...
 */
exports.MACRO_ADJUSTMENT_ORDER = [
    'protein',
    'carbs',
    'fat',
];
 ...
 */
function recordConstraintHit(constraints, ingredientId, ingredientName, maxGrams, requestedGrams) {
