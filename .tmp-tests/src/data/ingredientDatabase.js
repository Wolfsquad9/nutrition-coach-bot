...
exports.coreIngredients = void 0;
exports.getIngredientsByCategory = getIngredientsByCategory;
exports.getIngredientsByTags = getIngredientsByTags;
exports.calculateMacros = calculateMacros;
exports.findIngredientsByNutrition = findIngredientsByNutrition;
exports.getIngredientsByMealTime = getIngredientsByMealTime;
exports.createEmptyMealData = createEmptyMealData;
exports.createEmptyDailyMealPlan = createEmptyDailyMealPlan;
exports.coreIngredients = [
    // PROTEINS
    {
        id: 'chicken-breast',
        name: 'Chicken Breast',
...
function getIngredientsByCategory(category) {
    return exports.coreIngredients.filter(ing => ing.category === category);
}
// Helper function to get ingredients by tags
function getIngredientsByTags(tags) {
    return exports.coreIngredients.filter(ing => tags.some(tag => ing.tags.includes(tag)));
}
// Helper function to calculate macros for a given serving size
function calculateMacros(ingredient, servingSize) {
...
function findIngredientsByNutrition(criteria) {
    return exports.coreIngredients.filter(ing => {
        const macros = ing.macros;
        return ((!criteria.minProtein || macros.protein >= criteria.minProtein) &&
...
function getIngredientsByMealTime(mealTime) {
    return exports.coreIngredients.filter(ing => ing.allowedMeals.includes(mealTime));
}
// Helper function to create an empty meal data structure
function createEmptyMealData() {
    return {
        ingredients: [],
        recipeText: '',
...
function createEmptyDailyMealPlan() {
    return {
